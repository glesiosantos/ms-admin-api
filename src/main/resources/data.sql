insert into clientes (ativo, integrado,  vencimento, cpf_cnpj, razao, nm_fantasia, modulo, cep, logradouro, bairro, cidade, uf, complemento, latitude, longitude, plano, proprietario, cpf) values
...
insert into pedidos (cliente_id, usuario_responsavel_id, chave_compartilhamento, dt_expiracao, id_cob_asaas, plano, qr_code, qr_code_hash, situacao, dt_criado_em) values
    ((select id from clientes c where c.cpf_cnpj = '21344844000120'), (select id from usuarios u where u.email = 'admin@ohgestor.com.br'), '00020101021226820014br.gov.bcb.pix2560pix-h.asaas.com/qr/cobv/b82bd7e7-1ab8-4f99-b3e9-7fbb778d997e5204000053039865802BR5922Glesio Santos da Silva6008Teresina61086401053062070503***630497E5',
    ...
    '2609a2251e2a1a934a99539ba54d6e55','PENDENTE', '2025-02-25')
on conflict do nothing;