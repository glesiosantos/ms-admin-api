...
INSERT INTO tb_cliente_contatos (cliente_id, contatos) VALUES
    ((SELECT id FROM clientes WHERE cpf_cnpj = '33074389000179'), '+5586999928360'),
    ((SELECT id FROM clientes WHERE cpf_cnpj = '33074389000179'), '+5586988819817'),
    ((SELECT id FROM clientes WHERE cpf_cnpj = '37541733326'), '+5586992198688');